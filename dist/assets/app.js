...
function showScene(idx, direction) {
  ...
  var newPosClass = newEl.querySelector(".scene-text-wrap").className;
  ...
  var newWrap = newEl.querySelector(".scene-text-wrap");
...
function preloadImage(idx) {
  ...
  link.rel = "preload";
  link.as = "image";
  link.href = SCENES[idx].image + "?v=19";
...
function buildScene16(el) {
  ...
  for (var i = 0; i < 9; i++) {
    ...
    var vid = document.createElement("video");
    vid.src = "assets/scene16/scene16-0" + (i + 1) + ".mp4?v=19";
